...
<html>
	...
	<body>
		<a href="#show-LSResourceAccessibility" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="show-LSResourceAccessibility" class="content scaffold-show" role="main">
			...
			<ol class="property-list LSResourceAccessibility">
				...
				<li class="fieldcontain">
					<span id="resource-label" class="property-label"><g:message code="LSResourceAccessibility.resource.label" default="Resource" /></span>
						...
						<span class="property-value" aria-labelledby="resource-label"><g:link controller="LSResource" action="show" id="${LSResourceAccessibilityInstance?.resource?.id}">${LSResourceAccessibilityInstance?.resource?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${LSResourceAccessibilityInstance?.user}">
				<li class="fieldcontain">
			...
			<g:form url="[resource:LSResourceAccessibilityInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${LSResourceAccessibilityInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
